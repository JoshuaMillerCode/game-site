...
export default function LastFmInfo (props) {
    ...
    return (
        <>
            ...
            <img src='/img/lastFM_logo.png'></img>
                </div>
        ...
        <div className='endpointsDiv'>
            ...
            <h4>
                ...
                NOTE: These methods are only the methods that do NOT authentication for more information about request methods that required authentication please visit the <a href='https://www.last.fm/api#getting-started'>Last FM Api Docs</a>
            </h4>
            <div className='exampleTables'>
            <table style={{border: '2px black solid'}}>
                <thead>
                <tr>
                    <th colspan="2">method=album</th>
                </tr>
                </thead>
                <tbody>
                    <tr>
